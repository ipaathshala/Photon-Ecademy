...
<html lang="en">
  ...
  <body>
    <div class="wrapper-page">
      <div class="card">
        <div class="card-body">
          ...
          <div class="p-3">
            <h4 class="text-muted font-18 m-b-5 text-center">Create your account</h4>
            <form class="form-horizontal m-t-30">
              ...
              <div class="form-group m-t-10 mb-0 row">
                <div class="col-12 m-t-20">
                  ...
                  <div class="alert alert-success bg-success text-white" role="alert" id="success"><strong>Success!</strong> account created successfully</div>
                </div>
              </div>
              <div class="form-group m-t-10 mb-0 row">
                <div class="col-12 m-t-20">
                  <p class="font-14 text-muted mb-0 text-center">I've already registered - <a href="index" class="text-primary">Login to my account</a></p>
                </div>
              </div>
            </form>
          </div>
    ...
    <script src="plugins/custom-js/signup.js"></script>
  </body>
</html>