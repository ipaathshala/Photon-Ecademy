...
<html lang="en">
  ...
  <body>
              ...
              <div class="col-lg-12">
                <div class="page-title-box">
                  <div class="card m-b-20">
                    <div class="card-body">
                      <h4 class="mt-0 header-title">Create New PDF Post</h4>
                      <form>
                        <div class="row">
                          <div class="col-lg-4">
                        ...
                        <div class="row">
                          <div class="col-lg-12">
                            <div class="form-group">
                              <input type="text" class="form-control" data-parsley-minlength="6" placeholder="Enter Post Title" id="ptitle" name="ptitle" value="<?php echo$_POST['ptitle'];?>" autocomplete="off">
                            </div>
                          </div>
                          <div class="col-lg-12">
                            <div class="form-group">
                              <label>
                                Upload File 
                                <e class="text-danger">(file format should be pdf file)</e>
                              </label>
                          ...
                          <div class="col-lg-12">
                            <div class="form-group">
                              <div align="center">
                                ...
                                <button type="submit" name="submit" class="btn btn-success btn-lg"><i class="fa fa-file-pdf"></i> SAVE PDF POST</button>
                              </div>
                            </div>
                          </div>
                        </div>
    ...
    <script src="plugins/custom-js/savepdfPost.js"></script>
  </body>
</html>