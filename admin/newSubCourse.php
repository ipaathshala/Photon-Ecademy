                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-2">
                            <div class="form-group">
                              ...
                              <button type="submit" name="submit" class="btn btn-success btn-lg btn-block"> SAVE SUB COURSE</button>
                            </div>
                          </div>
                        </div>
                        <div class="row">
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td>
                              ...
                              <a href="newSubCourse?del=<?php echo $subCourserow['subcourse_id'];?>" class="btn btn-danger btn-sm" ><i class="fa fa-trash"></i> DELETE</a>
                            </td>
                          </tr>
                          <?php
                            }
