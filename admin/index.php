          ...
          <div class="p-3">
            ...
            <form class="form-horizontal m-t-30">
              ...
              <div class="form-group mb-0 row">
                <div class="col-12">
                  <p class="font-14 text-muted mb-0 text-center">I don't have account - <a href="signup" class="text-primary">Create New Account</a></p>
				  <p class="font-14 text-muted mb-0 text-center">Forgot your password? - <a href="#" class="text-primary">Click here</a></p>
                </div>
              </div>
            </form>
          </div>
