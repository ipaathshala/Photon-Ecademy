                      ...
                      <form method="post">
                        <div class="row">
                          ...
                          <div class="col-lg-2">
                            ...
                            <button type="submit" name="submit" class="btn btn-success btn-lg btn-block">SAVE COURSE</button>
                          </div>
                          <div class="col-lg-10">
                            <div class="form-group">
                      ...
                      <table class="table table-bordered mb-0 text-center">
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td>
                              <a href="editnewCourse?update=<?php echo $row['course_id'];?>" class="btn btn-primary btn-sm"><i class="fa fa-edit"></i> EDIT </a>
                              <a href="newCourse?del=<?php echo $row['course_id'];?>" class="btn btn-danger btn-sm"><i class="fa fa-trash"></i> DELETE</a>
                            </td>
                          </tr>
                          <?php
                            }
